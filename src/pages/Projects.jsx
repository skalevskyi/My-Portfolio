  ...
  const projects = [
    {
      ...
      image: process.env.PUBLIC_URL + '/images/montpellier.png',
    ...
    },
    {
      ...
      image: process.env.PUBLIC_URL + '/images/qr-code.png',
    ...
    },
    {
      ...
      image: process.env.PUBLIC_URL + '/images/animated-login.png',
